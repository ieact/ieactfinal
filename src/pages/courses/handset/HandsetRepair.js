            ...
            <Grid item xs={12} md={6} order={1}>
              ...
              <Box>
                ...
                <Typography variant="body1" lineHeight={2}>
                  Handset repair engineer is responsible for performing handset
                  repair, including hardware and software components, and
                ...
                <Typography variant="body1" lineHeight={2}>
                  This job requires the individual to be analytical and be able
                  to handle high-pressure situations to successfully perform the
                  assigned responsibilities. They should have basic written and
                  oral communication skills and should be able to apply
                  practical judgment to successfully perform the assigned
                  responsibilities.
                </Typography>
              </Box>
            </Grid>
