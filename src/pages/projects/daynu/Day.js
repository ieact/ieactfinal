        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={12} md={6} lg={6}>
            <Box sx={{ lineHeight: 2, justifyContent: "space-between" }}>
              ...
              <br />
              <Typography variant="h4">The components of the DAY-NULM are:
</Typography>
              <Typography variant="body1" sx={{ lineHeight: 2 }}>

              ⚫ Social Mobilization and Institution Development (SM&ID). <br />
              ⚫ Capacity Building and Training (CB&T).<br /> ⚫Employment through
                Skill Training and Placement (EST&P).<br />⚫ Self Employment Programme
                (SEP).⚫ Support to Urban Street Vendors (SUH). <br />⚫Scheme of Shelter
                for Urban Homeless (SUSV), and an exclusive component,
                Innovation & Special Projects (1&SP).
                <br />
              </Typography>
            </Box>
          </Grid>
